...
# Вызов функции write_words с указанными аргументами
...
threads = []
threads.append(Thread(target=threaded_write, args=(10, 'example5.txt')))
threads.append(Thread(target=threaded_write, args=(30, 'example6.txt')))
threads.append(Thread(target=threaded_write, args=(200, 'example7.txt')))
threads.append(Thread(target=threaded_write, args=(100, 'example8.txt')))
